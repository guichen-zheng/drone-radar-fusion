...
#define NODE_MAIN_LOGGER_NAME "hik_camera_ros2_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhik_camera_ros2_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hik_camera_ros2_driver::HikCameraRos2DriverNode>";
